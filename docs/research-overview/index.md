...
- [研究范围（Research Scope）](research-scope.md)：界定整个博士研究的长期边界。
- [研究路线图（Research Map）](research-map.md)：解释可信性目标、技术方向与应用场景之间的关系。
- [研究问题（Research Questions）](research-questions.md)：整理长期问题与当前待检验的问题。
- [当前研究重点（Current Focus）](current-focus.md)：说明现阶段的技术兴趣、研究方式和下一步目标。

首次阅读可以从研究范围开始；了解近期工作重点时，可以直接进入当前研究重点。
