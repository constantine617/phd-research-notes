...
## 三类资源：医学考试、影像问答与胸部影像报告

| 资源 | 任务与参照 | 使用边界 |
|---|---|---|
| MedQA（[Jin et al., 2021](https://doi.org/10.3390/app11146421 "文献引用")） | 来自医学考试的多项选择问题与答案 | 评价知识与问题求解；不是图像忠实性或真实诊疗效果评价 |
| VQA-RAD（[Lau et al., 2018](https://www.nature.com/articles/sdata2018251 "文献引用")） | 临床人员针对放射影像提出问题并提供答案 | 专业标注有价值，但图像和问题范围有限；固定数据版本与划分 |
| MIMIC-CXR（[Johnson et al., 2019](https://www.nature.com/articles/s41597-019-0322-0 "文献引用")） | 胸部影像与同期自由文本报告 | 是可支持多种任务的数据库，并非单一固定 benchmark；访问需满足官方要求 |

MedQA 原始预印本为 2020，正式期刊论文为 2021；本页引用正式版本。不同语言、选项整理方式或派生子集应分别说明，不能只写一个数据集名称。

## 报告不是逐句图像真值

[Johnson et al. (2019)](https://www.nature.com/articles/s41597-019-0322-0 "文献引用") 说明放射科医生在报告时还可能看到简要临床背景与既往影像。若模型输入只有当前图像，参考报告中的比较或病史内容未必能从该图像单独推得。
