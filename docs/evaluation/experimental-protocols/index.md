...
Mitchell et al. (2019) 的 Model Cards 强调模型细节、用途与分组评价；Gebru et al. (2021) 的 Datasheets 强调数据建立与使用过程。这些记录可以帮助说明一次实验的适用边界，但文档齐全本身不能证明实验无偏。
